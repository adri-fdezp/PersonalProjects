...
var rgb_default2 = (function rgbGamma2(y) {
  var color2 = gamma2(y);
  function rgb2(start2, end) {
    var r = color2((start2 = rgb(start2)).r, (end = rgb(end)).r), g = color2(start2.g, end.g), b = color2(start2.b, end.b), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t) {
      start2.r = r(t);
      start2.g = g(t);
      start2.b = b(t);
...
function hsl3(hue3) {
  return function(start2, end) {
    var h = hue3((start2 = hsl(start2)).h, (end = hsl(end)).h), s = nogamma2(start2.s, end.s), l = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t) {
      start2.h = h(t);
      start2.s = s(t);
      start2.l = l(t);
...
function hcl3(hue3) {
  return function(start2, end) {
    var h = hue3((start2 = hcl(start2)).h, (end = hcl(end)).h), c = nogamma2(start2.c, end.c), l = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t) {
      start2.h = h(t);
      start2.c = c(t);
      start2.l = l(t);
...
function cubehelix3(hue3) {
  return (function cubehelixGamma(y) {
    y = +y;
    function cubehelix4(start2, end) {
      var h = hue3((start2 = cubehelix(start2)).h, (end = cubehelix(end)).h), s = nogamma2(start2.s, end.s), l = nogamma2(start2.l, end.l), opacity = nogamma2(start2.opacity, end.opacity);
      return function(t) {
        start2.h = h(t);
        start2.s = s(t);
        start2.l = l(Math.pow(t, y));
...
function interpolate_default2(a, b) {
  var c;
  return (typeof b === "number" ? number_default3 : b instanceof color ? rgb_default2 : (c = color(b)) ? (b = c, rgb_default2) : string_default2)(a, b);
}
